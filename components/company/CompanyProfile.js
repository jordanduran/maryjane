        ...
        <main className='py-10 sm:ml-5'>
          ...
          <div className='mt-8 max-w-3xl mx-auto grid grid-cols-1 gap-6 sm:px-6 lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-3 pl-5 pr-5 rounded-lg'>
            <div className='space-y-6 lg:col-start-1 lg:col-span-2 rounded-lg'>
              <section aria-labelledby='applicant-information-title'>
                <div className='bg-white shadow overflow-hidden rounded-md'>
                  {/* <ProductList companies={DUMMY_COMPANIES} /> */}
                </div>
              </section>
                    ...
                    <form action='#'>
                      <div>
                        ...
                        <textarea
                          ...
                          name='comment'
                          rows='3'
                          className='shadow-sm block w-full focus:ring-green-500 focus:border-green-500 sm:text-sm border-gray-300 rounded-md'
                          placeholder='Recently purchased from this vendor? Leave a review!'
                        ></textarea>
                      </div>
                      <div className='mt-3 flex items-center justify-between'>
                        <button
                          type='submit'
                          className='inline-flex items-center sm: w-full justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-green-500 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500'
                        >
                          Submit Review
                        </button>
                      </div>
